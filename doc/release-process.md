...
* Update manpages, see [gen-manpages.sh](https://github.com/LucienZerger/straya-coin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/LucienZerger/straya-coin-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/LucienZerger/straya-coin.git
...
- Detached signatures will then be committed to the [strayacoin-detached-sigs](https://github.com/LucienZerger/straya-coin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/LucienZerger/straya-coin/releases/new) with a link to the archived release notes.
